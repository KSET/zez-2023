...
export const Tag: FC<PropsWithChildren<TagProps>> = ({
  ...
  return (
    <button
      ...
      type="button"
      className={cn(
        "rounded-full border border-off-black stroke-off-black px-3 py-[2px] text-xl font-semibold uppercase leading-none tracking-widest text-white br:px-3 br:py-0 br:text-2xl",
        asDisplay && "cursor-text",
        !asDisplay &&
          "hover:hover-hover:pointer-fine:border-off-black hover:hover-hover:pointer-fine:!bg-off-black hover:hover-hover:pointer-fine:!text-white",
